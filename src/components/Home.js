...
import { GEOLOCATION_OPTIONS, POSITION_KEY, TOKEN_KEY, API_ROOT, AUTH_HEADER, POST_TYPE_IMAGE, POST_TYPE_VIDEO,TOPIC_AROUND,TOPIC_FACE} from "../constants";
    ...
    getGeolocation() {
        ...
        if('geolocation' in navigator) {
            navigator.geolocation.getCurrentPosition(
                this.onGeolocationSuccess,this.onGeolocationFailure,GEOLOCATION_OPTIONS);

           /* this.onGeolocationSuccess({
                coords: {
                    latitude:37.4030336,
                    longitude:-122.09520640000001
                }
            });*/
